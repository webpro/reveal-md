...
const { getInitialDir, getInitialPath, getAssetsDir, getHost, getPort, getWatch } = require('./config');
...
module.exports = async () => {
  ...
  app.use('/template', staticDir(path.join(__dirname, "template")));
  ...
  app.use(`/${assetsDir}`, staticDir(process.cwd()));
