...
const getOptions = () => _.defaults({}, config.args, config.local, config.defaults);

const getSlideOptions = (yamlOptions, extraOptions) => {
...
const parsePreprocessor = preprocessor => {
