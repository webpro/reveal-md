...
module.exports.getWebManifestPath = (manifest, assetsDir, base) => getAssetPath(manifest, assetsDir, base);
module.exports.getServiceWorkerPath = (serviceworker, base) =>
  isAbsoluteURL(serviceworker) ? serviceworker : `${base || ''}/${serviceworker}`;
